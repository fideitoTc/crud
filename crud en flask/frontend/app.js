function consulta_general(){
    let url = "http://127.0.0.1:5000/";
                ...
                const visualizar = (data) => {
                    ...
                    for (var i = 0; i < data.baul.length; i++) {
                        console.log(i,data.baul[i].id_baul)
    ...
    <button type='button' class="btn btninfo" onclick="location.href =
   'edit.html?variable1=${data.baul[i].id_baul}'"> <img
   src='imagenes/editar.png' height ='30' width='30'/></button>
    
   <button type='button' class="btn btnwarning" onclick="eliminar(${data.baul[i].id_baul})"> <img
   src='imagenes/Iconos gratuitos de Eliminar diseñados por Kiranshastry.jpg' height ='30'
   width='30'/></button>
